...
<img src="../images/2024-02-05-nlp1/image.png" alt="RNN" style="zoom:33%;" />최근의 연구들은 sequence의 긴 길이에서 메모리 제약을 없애기 위해 계산 효율성을 높이는 방법을 제시를 하였으나, 기본적인 sequence data의 제약은 많이 남아있다.  

<img src="../images/2024-02-05-nlp1/img.png" alt="Attention Mechanism" style="zoom:33%;" />
...
<img src="../images/2024-02-05-nlp1/image-20240205135046659.png" alt="image-20240205135046659" style="zoom:33%;" />
...
<img src="../images/2024-02-05-nlp1/image-20240205170159471.png" alt="image-20240205170159471" style="zoom:33%;" />
...
$$
\text{MultiHead}(Q, K, V) = \text{Concat}(\text{head}_1, ..., \text{head}_h)\\ \text{where} \quad \text{head}_i = \text{Attention}(QW_{i}^{Q}, KW_{i}^{K}, VW_{i}^{V})
$$
